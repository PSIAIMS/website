...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../../images/openblogp2.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../../images/openblogp3.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../../images/openblogp4.png")
```
...
See this helpful cheat sheet for basic commands – https://iqss.github.io/dss-workshops/R/Rintro/base-r-cheat-sheet.pdf
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../../images/openblogp5.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../../images/openblogp6.png")
```
