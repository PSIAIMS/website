...
<div class="page-shell">
  ...
  <section class="journey">
    <div class="journey-copy">
      Start at the top and move stage by stage. You can revisit any stage whenever a real project exposes a gap.
    </div>

    <div class="journey-nav">
      <p class="section-title">Recommended path</p>
      <p class="section-copy">Move down the path, then return whenever a real project reveals a gap.</p>
      ...
      <div class="stage-list">
        ...
        <button class="stage-btn" id="btn-trials" onclick="showStage('trials')">
          ...
          <span class="stage-copy">
            <span class="stage-title">Choose Your Direction</span>
            <span class="stage-sub">Follow the analyses, outputs, and areas that are most relevant to your role.</span>
          </span>
        </button>
      </div>
    </div>
      ...
      <div class="panel" id="panel-trials">
        <div class="panel-head">
          <div>
            ...
            <h2>Choose the directions that fit your role</h2>
          </div>
          <button class="close-btn" onclick="showStage('orientation')">Back to start</button>
        </div>
        <p class="panel-intro">
          Once you can read and adapt code, the next step is to deepen the parts of R that matter most for your role, your interests, and the kinds of outputs you are likely to create.
        </p>
        <div class="panel-rule"></div>
        <div class="panel-grid">
          <div class="content-card">
            <h3>Goal</h3>
            <p>Move from basic comfort with R into areas of practice that feel genuinely useful, whether that means analysis, visualisation, dashboards, reporting, or reproducible workflows.</p>
          </div>
          <div class="content-card">
            <h3>Possible directions</h3>
            <ul>
              <li>Meta-analysis or evidence synthesis</li>
              <li>Survival or time-to-event analysis</li>
              <li>Repeated measures or longitudinal work</li>
              <li>Data visualisation and communication</li>
              <li>Dashboards or interactive tools</li>
              <li>Tables, listings, figures, and reporting workflows</li>
              <li>Reproducible pipelines and project structure</li>
            </ul>
          </div>
          <div class="content-card">
            <h3>Ask AI this</h3>
            <div class="prompt-list">
              <div class="prompt">"Based on the work I am likely to do, what would be a good next R project for me?"</div>
              <div class="prompt">"If I want to learn R through meta-analysis, what packages, example tasks, and prompts should I start with?"</div>
              <div class="prompt">"If I care more about dashboards and communication than modelling, how should I learn R differently?"</div>
              <div class="prompt">"Show me how this kind of analysis or output could become a reusable R workflow."</div>
            </div>
          </div>
          <div class="content-card">
            <h3>Recommended resources</h3>
            <div class="resource-list">
              <a class="resource-card" href="https://quarto.org/docs/authoring/markdown-basics.html" target="_blank" rel="noopener">
                ...
                <span>Useful when your chosen direction involves reports, notes, or shareable outputs.</span>
                <em>quarto.org</em>
              </a>
              <a class="resource-card" href="https://www.tidyverse.org/" target="_blank" rel="noopener">
                <strong>Tidyverse</strong>
                <span>A core ecosystem you will keep returning to across many different types of work.</span>
                <em>tidyverse.org</em>
              </a>
            </div>
          </div>
        </div>
        <div class="panel-foot">The important move here is not picking the "right" topic in the abstract. It is choosing a direction that feels pertinent to your role and using that to drive the next stage of learning.</div>
      </div>
    </div>
  </section>
</div>
