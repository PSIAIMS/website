...
![Example multi-select dropdown with search, Select All, Deselect All, and selected checkmarks.](interactive-outputs/prompt-3-multiselect-example.svg){fig-alt="Example multi-select dropdown with search, Select All, Deselect All, and selected checkmarks."}
