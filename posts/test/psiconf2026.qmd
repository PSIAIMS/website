...
For the website, render the dashboard once and place the resulting `psi-conf-2026-dashboard.html` file in the site `assets/` folder.
...
### Dashboard Full Code {#dashboard-full-code}
