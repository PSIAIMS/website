...
![Quarto Dashboard converted to Shiny](interactive-outputs/recipe-4-preview-01-quarto-dashboard.svg){fig-alt="Quarto Dashboard converted to Shiny."}

Quarto Dashboard converted to Shiny
...
![Sidebar Filters Added](interactive-outputs/recipe-4-preview-02-basic-shiny.svg){fig-alt="Sidebar Filters Added."}
...
![Sidebar Filters Improved and Downloads Added](interactive-outputs/recipe-4-preview-03-filters-downloads.svg){fig-alt="Sidebar Filters Improved and Downloads Added."}

Sidebar FIlters Improved and Downloads Added
...
![Name and Design Improved](interactive-outputs/recipe-4-preview-04-polished-shiny.svg){fig-alt="Name and Design Improved."}

Name and Design Improved
